...
class BllitProcessor(ProcessorMixin):
	...
	image_processor_class = ("BllitImageProcessor", "BllitImageProcessorFast")
	point_processor_class = ("BllitPointProcessor", "BllitPointProcessorFast")
	...
	def __call__(self,
		...
		**kwargs: Unpack[BllitProcessorKwargs],
		...
		Args:
			images:
				Image input for BllitProcessor
			points:
				Point cloud input for BllitProcessor
			text:
				Text input for BllitProcessor
			audio:
				Blah
			video:
				Blah
